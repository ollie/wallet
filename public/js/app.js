...
(function() {
  ...
  BalanceChart = (function() {
    ...
    BalanceChart.prototype.init = function() {
      return $.getJSON(this.element.data('url'), (function(_this) {
        return function(data) {
          ...
          return Highcharts.stockChart(_this.element.attr('id'), options);
        };
      })(this));
    };
  ...
  TagEntriesChart = (function() {
    function TagEntriesChart() {
    ...
    TagEntriesChart.prototype.init = function() {
      return $.getJSON(this.element.data('url'), (function(_this) {
        return function(data) {
